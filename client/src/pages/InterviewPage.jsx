...
const InterviewPage = () => {
  ...
  const currentQuestions = questions[interviewType] || questions.general;
  ...
  const handleCompleteInterview = () => {
    ...
    setTimeout(() => {
      navigate(`/feedback?type=${interviewType}&score=85`);
    }, 2000);
  };
              ...
              <div className="bg-gradient-to-r from-purple-50 to-blue-50 rounded-lg p-6 mb-8">
                ...
                <div className="grid md:grid-cols-3 gap-4 text-sm">
                  <div>
                    ...
                    <p className="font-medium text-gray-900">{setupData.role}</p>
                  </div>
                  <div>
                    <span className="text-gray-600">Experience:</span>
                    <p className="font-medium text-gray-900">{setupData.experience}</p>
                  </div>
                  <div>
                    <span className="text-gray-600">Tech Stack:</span>
                    <p className="font-medium text-gray-900">
                      {setupData.stack.length > 0 ? setupData.stack.slice(0, 3).join(', ') + (setupData.stack.length > 3 ? '...' : '') : 'Not specified'}
                    </p>
                  </div>
                </div>
              </div>
